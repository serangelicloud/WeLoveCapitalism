...
public class TradesDatabase {
    ...
    public static void writeTrade(Trade trade) throws SQLException {
        ...
        statement.setInt(3, trade.getMultiplier());
        ...
        statement.setLong(11, trade.getTimestamp());

        statement.setBoolean(12, trade.isActive());
    ...
    public static HashSet<Trade> parseTrades() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            Bukkit.getLogger().info("id: " + tradeId + " amount: " + amount + " price: " + price);
